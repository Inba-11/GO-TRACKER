#!/usr/bin/env python3
"""
Complete CodeChef data updater for INBATAMIZHAN P (711523BCB023)
Scrapes and updates ALL CodeChef data including:
- Ratings (current & max)
- Problems solved (total, fully, partially)
- Contest history
- Submission heatmap
- Submission statistics
- Profile information (institution, country, etc.)
"""
...
def update_codechef_complete():
    """Update ALL CodeChef data for INBATAMIZHAN P"""
    try:
        # Connect to MongoDB
        ...
        logger.info(f"================================================================================")
        logger.info(f"CODECHEF COMPLETE DATA UPDATER")
        logger.info(f"================================================================================")
        logger.info(f"Updating ALL CodeChef data for {roll_number}")
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("CODECHEF COMPLETE DATA UPDATER")
    print("="*80)
    print(f"Updating ALL CodeChef data for INBATAMIZHAN P (711523BCB023)")
    print(f"Username: kit27csbs23")
    print("="*80 + "\n")
    
    success = update_codechef_complete()
